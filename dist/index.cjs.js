...
var buildUrl = function buildUrl(baseUrl) {
  ...
  var uri = (_URI__default$default = URI__default['default']).joinPaths.apply(_URI__default$default, _toConsumableArray(args));
...
var RestClient = /*#__PURE__*/function () {
  ...
  _createClass(RestClient, [{
    ...
    value: function request(opts, callback) {
      ...
      if (!___default['default'].isNull(opts.data)) {
        options.data = qs__default['default'].stringify(opts.data, {
          arrayFormat: 'repeat'
        });
      }

      if (!___default['default'].isNull(opts.params)) {
    ...
    value: function _addInterceptors() {
      ...
      this.service.interceptors.response.use(function (response) {
        ...
        if (_this20.useCamelCase) {
          response.data = humps__default['default'].camelizeKeys(response.data);
        }
